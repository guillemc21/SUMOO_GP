            ...
            <nav class="text-center my-5 d-flex flex-column">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        ...
                        <a href="{{route('store.category', $category->name)}}" class="dropdown-item {{  (isset($categoryIdSelected) && $category->id == $categoryIdSelected)? 'selected-category': '' }}">{{$category->name}}</a>
                        @endforeach
                    </div>
                </div>
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        ...
                        <a href="{{route('store.brand', $brand->name)}}" class="dropdown-item {{  (isset($brandIdSelected) && $brand->id == $brandIdSelected)? 'selected-brand': '' }}">{{$brand->name}}</a>
                        @endforeach
                    </div>
                </div>
